...
Through LilyPad, Users will be able to listen to music from any of the platforms that they have accounts on and have linked, including Spotify, Youtube Music, and Apple Music. Individual users will also be capable of building their own playlists, sourcing songs from a variety of platforms. Users will also be able to _**search**_ for playlists that other users have created on LilyPad, and a _**search**_ functionality will also allow users to find any version of a song that they want to listen to. There will also be a favorite feature that users can apply to other users who share similar tastes, and on songs that users like more than other versions. With the capability that LilyPad provides, users will also have the power to convert a playlist that they had made on a single platform onto another platform, or convert it to a LilyPad specific playlist.
